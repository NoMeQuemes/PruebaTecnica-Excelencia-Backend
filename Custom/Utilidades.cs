...
namespace Prueba_Tecnica_Api.Custom
{
    public class Utilidades
    {
        private readonly ApplicationDbContext _db;
        private readonly IConfiguration _configuration;
        public Utilidades(IConfiguration configuration, ApplicationDbContext db)
        {
            _db = db;
        ...
        {
            var oldTokens = await _db.RefreshTokens.Where(rt => rt.idUsuario == idUsuario && rt.esActivo).ToListAsync();
